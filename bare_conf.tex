...
However, a lengthy manual tuning process in order to find the exact weights for a given junction is not only untranslatable to any other junction but also may not result in reduced planning and execution times compared with traditional control.
